...
3. Create a test service which will output simple message 'Hello world' in the browser window
4. Map the test service to the "/users" path
...
14. Add a service with the "/liked" address, output a static (hardcoded) list of profiles that user "liked"
...
18. Add a service with the "/messages/{id}" address, show a static chat with harcoded messages there
...
24. Create a doPost method in the corresponding service, which will save the new message to the database
