...
<body class="text-center">
    <form class="form-signin" method="post">
        <img  class="mx-auto rounded-circle img-fluid" style="height: 100%; width: 100%; max-height: 100px; max-width: 100px; object-fit: cover" src="https://icon2.cleanpng.com/20180622/pwy/kisspng-cercanas-bilbao-zorrotza-renfe-operadora-cercan-tinder-5b2d1716c16048.0838255415296816867921.jpg">
        ...
        <input type="url" name="url_photo" id="inputEmail" class="form-control" placeholder="photo URL (not a mandatory field)">
